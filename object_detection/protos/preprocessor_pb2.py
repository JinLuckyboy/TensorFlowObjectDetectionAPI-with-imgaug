...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_imgaug', full_name='object_detection.protos.PreprocessingStep.random_imgaug', index=38,
...
_RANDOMIMGAUG = _descriptor.Descriptor(
  name='RandomImgAug',
  full_name='object_detection.protos.RandomImgAug',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='random_coef', full_name='object_detection.protos.RandomImgAug.random_coef', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['RandomImgAug'] = _RANDOMIMGAUG
...
RandomImgAug = _reflection.GeneratedProtocolMessageType('RandomImgAug', (_message.Message,), {
  'DESCRIPTOR' : _RANDOMIMGAUG,
  '__module__' : 'object_detection.protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomImgAug)
  })
_sym_db.RegisterMessage(RandomImgAug)
